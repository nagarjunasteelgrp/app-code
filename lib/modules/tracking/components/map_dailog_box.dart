          ...
          child: Dialog(insetPadding: EdgeInsets.symmetric(horizontal: 4.w, vertical: 2.h),
              ...
              child: Consumer<TrackingProvider>(
                  builder: (context, provider, _) {
                    print("TRACKING PROVIDER MAP DAILOG BOX:----------1 ${provider.latitude}");
                    print("TRACKING PROVIDER MAP DAILOG BOX:----------2 ${provider.longitude}");
                    print("TRACKING PROVIDER MAP DAILOG BOX:----------3 ${provider.address}");
                          ...
                          Container(
                            ...
                            child: GoogleMap(
                              ...
                              initialCameraPosition: CameraPosition(
                                target: LatLng(provider.latitude ?? 0.0, provider.longitude ?? 0.0),
                                zoom: 12.0,
                              ),
                            ),
                          ),
