                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            appCircleIcon(
                              ...
                              height: 8.w,
                              width: 8.w,
                              child: SvgPicture.asset(AppAssets.APP_CHECKING_SVG,
                                  color: Theme
                                      .of(context)
                                      .primaryColor),
                            ),
                       ...
                       appOutlineButton(context: context,
                         height: 4.h,
                         radius: 0.6.h,
                         onTap: (){
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              AppText(
                                                title: '${Constants.total_working_hour} :',
                                                fontSize: 1.6.h,
                                                fontWeight: FontWeight.w500,
                                              ),
                                              SizedBox(
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                AppText(
                                                  title:
                                                  provider.checkInList[index]['user']['name'],
                                                  fontSize: 1.6.h,
                                                ...
                                                AppText(
                                                  title:provider
                                                      .checkInList[index]['workingHours'] != null ?
                                                  provider
                                                      .checkInList[index]['workingHours'].toStringAsFixed(3) : 'Remaining check out time',
                                                  fontSize: 1.6.h,
                                                  fontWeight: FontWeight.w600,
                                                ),
                                                SizedBox(
