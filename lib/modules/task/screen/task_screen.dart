                              ...
                              GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Align(
                                      ...
                                      child: SvgPicture.asset(AppAssets.APP_FILTER_SVG,color: Colors.black,)),
                                ),
                              ),
                              Column(
                                children: List.generate(
                                  ...
                                  return taskContainerUI(
                                    onTap: (){
                                      ...
                                      print("------------------------------------TAP------------------------------------${value.statusId}");
                                      taskStatusDailogBox(context,value.statusId);
                                    },
                                    context,
                                    colors: value.filteredTaskAPIResponse[index]['status'] == "assigned" ? Theme.of(context).colorScheme.outline.withOpacity(0.8) : value.filteredTaskAPIResponse[index]['status'] == "completed" ? Theme.of(context).colorScheme.onInverseSurface : Theme.of(context).colorScheme.onSurfaceVariant,
                                    title: value.filteredTaskAPIResponse[index]['title'],
                                    description: value.filteredTaskAPIResponse[index]
                                        ['description'],
                                    type: value.filteredTaskAPIResponse[index]['titleType'],
