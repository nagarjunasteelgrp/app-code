                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: List.generate(
                                provider.notificationList.length, (index) {
                              return Padding(
                                  padding: EdgeInsets.symmetric(
                                    vertical: 1.h,
                                    horizontal: 4.w,
                                  ...
                                  child: Container(
                                    ...
                                    child: ListTile(
                                      title: AppText(
                                        title:
                                            "${provider.notificationList[index]['dealerName']}",
                                        fontSize: 12,
                                      ...
                                      subtitle: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: AppText(
                                              title:
                                                  "${provider.notificationList[index]['notes']}",
                                              fontSize: 12,
                                              maxLines: 5,
                                            ),
                                          ),
                                          AppText(
                                            title:
                                                "${provider.notificationList[index]['formattedFollowUpDate']}",
                                            fontSize: 12,
                                          ),
                                        ],
                                      ),
                                      trailing: AppText(
                                        title: provider.notificationList[index]
                                            ['status'],
                                        fontSize: 12,
                                      ),
                                    ),
