  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CommonAppBar(
        ...
        onTap: (){
          Provider.of<ContactProvider>(context,listen: false).toggleDetails(false);
         Provider.of<ContactProvider>(context,listen: false).toggleSelected(true);
         // //  Provider.of<ContactProvider>(context, listen: false).toggleSelected(false);
      ...
      body: Consumer<HomeProvider>(builder: (context, value, _) {
        return value.selectedIndex == 4
            ...
            : value.selectedIndex == 0
                ? const ContactScreen()
                : value.selectedIndex == 2 ? CheckInScreen() : SizedBox();
      }),
